...
# Prompts the user for a value between 0 and 3 to select the data wanted
id_num = int(input("Please enter a number between 0 and 3 to select the data you want (0 = A, 1 = B, 2 = C, 3 = D): "))
if id_num < 0 or id_num > 3:
...
skim_name = "1lep"
value = samples['data']['list'][id_num] # Picks data from A-D
...
with open(filename+".pkl", "wb") as f:
    pickle.dump([b_jet_selection_cut, jet_pt_cut, lep_pt_cut, lep_eta_cut, jet_eta_cut, met_Et_cut, lep_phi_cut, 
                 met_phi_cut, lep_E_cut, jet_E_cut, jet_phi_cut, MtW_cut, HT_cut, m_lb_cut], f)
